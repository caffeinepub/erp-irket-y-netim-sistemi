...
export default function ManagerLogin() {
  ...
  useEffect(() => {
    if (identity && isFetched && userProfile) {
      if (userProfile.role === CompanyRole.Manager) {
        navigate({ to: '/manager' });
      } else {
        setError('Bu hesap yetkili değil. Lütfen doğru giriş ekranını kullanın.');
      }
    }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 dark:from-neutral-900 dark:via-neutral-800 dark:to-neutral-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-orange-700 dark:text-orange-300">Yükleniyor...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 dark:from-neutral-900 dark:via-neutral-800 dark:to-neutral-900 flex items-center justify-center p-4">
        <Card className="w-full max-w-md border-2 border-orange-200 dark:border-orange-800">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl text-orange-900 dark:text-orange-100">Davet Kodu Girişi</CardTitle>
            <CardDescription className="text-orange-700 dark:text-orange-300">
              Yetkili olarak kayıt olmak için davet kodunuzu girin
            </CardDescription>
          </CardHeader>
          <CardContent>
