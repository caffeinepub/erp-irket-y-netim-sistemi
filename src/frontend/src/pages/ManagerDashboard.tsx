...
import { Users, CheckSquare, Bell, BarChart3 } from 'lucide-react';
...
export default function ManagerDashboard() {
  ...
  if (!userProfile || userProfile.role !== CompanyRole.Manager) {
    return (
      <div className="flex items-center justify-center min-h-screen">
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-orange-900 dark:text-orange-100 mb-2">Hoş Geldiniz, {userProfile.name}</h1>
        <p className="text-orange-700 dark:text-orange-300">Yetkili Paneli</p>
      </div>

      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="hover:shadow-lg transition-shadow cursor-pointer border-2 border-orange-200 dark:border-orange-800" onClick={() => navigate({ to: '/manager/employees' })}>
          <CardHeader>
            ...
            <CardTitle className="text-orange-900 dark:text-orange-100">Personel Listesi</CardTitle>
